...
public class testOrderCustomer {
  ...
  public testOrderCustomer(String name, String surname, String address, String subway, String telephone, String date, String periods, String comment) {
    this.name = name;
  ...
  public static Object[][] getTestData() {
    return new Object[][] {
            { "Василий", "Сидоров", "Воздвиженка, 15-1", "Арбатская", "+79991707777", "10.12.2022", "сутки", "абв" },
            { "Сергей", "Иванов", "Проспект Мира, 29-2-1", "Проспект Мира", "+79991889922", "12.12.2022", "трое суток", "бва" },
    };
  }
  ...
  @Test
  public void checkOrderFormWithHeadButton() throws InterruptedException {
   ...
   // кликни на кнопку Далее страницы заполнения формы заказа
    ...
    Thread.sleep(10_000);
    // Заполнить форму заказа.
    objProfileCustomerPage.fillSecondForm(date, periods, comment);
